...
export const es: LandingContent = {
  ...
  ui: {
    ...
    portalNavLabel: "Mi área",
    signInNavLabel: "Entrar",
    blogLinkLabel: "Blog",
  ...
  contact: {
    ...
    errorGeneric: "No pudimos enviar tu mensaje. Inténtalo de nuevo.",
  ...
  leadMagnetSection: {
    ...
    form: {
      ...
      privacyNote: "Usamos tu correo solo para enviarte la guía y tips ocasionales. Consulta nuestra",
      privacyLinkLabel: "política de privacidad",
