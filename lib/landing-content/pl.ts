...
export const pl: LandingContent = {
  ...
  nav: {
    ...
    links: [
      ...
      { label: "Darmowy przewodnik", href: "/recursos" },
  ...
  leadMagnetSection: {
    ...
    form: {
      ...
      privacyNote: "Używamy Twojego e-maila tylko do wysyłki przewodnika i okazjonalnych tipów. Możesz się wypisać w każdej chwili.",
